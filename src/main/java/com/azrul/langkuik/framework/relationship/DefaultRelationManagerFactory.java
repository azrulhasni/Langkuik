        ...
        RelationManager<P, C> rm = new RelationManager<P, C>() {
            ...
            public void link(P parentObject, C currentObject,
                ...
                try {
                    ...
                    if (Collection.class.isAssignableFrom(FieldUtils.getField(parentObject.getClass(),parentToCurrentField).getType())) {
                        Field field = FieldUtils.getField(parentObject.getClass(),parentToCurrentField);
