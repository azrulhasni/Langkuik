...
public class UserSearchResultView<C,W> extends VerticalView {
    ...
    public UserSearchResultView(Class<C> classOfBean, int noBeansPerPage,
    ...
    public void enter(final ViewChangeListener.ViewChangeEvent vcevent) {
        ...
        if (dataTable == null) {
            ...
            dataTable = new UserSearchResultDataTable<>(searchQuery,
                    classOfBean,
                    dao,
                    noBeansPerPage,
                    /*currentUserRoles,*/
...
//        if (entityRight.equals(EntityRight.CREATE_UPDATE) || entityRight.equals(EntityRight.CREATE_UPDATE_DELETE)) {
//            Button addNewBtn = new Button("Add new",
//                    new Button.ClickListener() {
//                @Override
//                public void buttonClick(Button.ClickEvent event
//                ) {
//                    C currentBean = dao.createAndSave(classOfBean,);
...
//        }
        ...
        Button deleteBtn = new Button(pageParameter.getLocalisedText("form.general.button.delete"),
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                if (!currentBeans.isEmpty()) {
                    ConfirmDialog.show(UserSearchResultView.this.getUI(), pageParameter.getLocalisedText("dialog.delete.header"), pageParameter.getLocalisedText("dialog.delete.confirmText"),
