...
public class UserSearchResultDataTable<C> extends DataTable<C> {
    ...
    public UserSearchResultDataTable(FindAnyEntityQuery<C> parameter, Class<C> classOfBean, DataAccessObject<C> dao, int noBeansPerPage,/*final Set<String> currentUserRoles,*/ final EntityRight entityRight, final PageParameter pageParameter) {
