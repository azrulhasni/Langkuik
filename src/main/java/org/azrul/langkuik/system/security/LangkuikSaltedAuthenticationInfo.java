 ...
 * @author Azrul
 */
public class LangkuikSaltedAuthenticationInfo  implements SaltedAuthenticationInfo {
  ...
  public LangkuikSaltedAuthenticationInfo(String username, String password, String salt) {
